...
<html lang="en">
    ...
    <head>
        ...
        <link href="/thinkBlogs/Public/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="/thinkBlogs/Public/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="/thinkBlogs/Public/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="/thinkBlogs/Public/assets/pages/img/logo-big.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="" method="post">
                ...
                <div class="form-group userbox">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix username" type="text" autocomplete="off" placeholder="Username" name="username" />
                    </div>
                    <span id="usererr" class="help-block"></span>
                </div>
                <div class="form-group passbox">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix password" type="password" autocomplete="off" placeholder="Password" name="password" />
                    </div>
                    <span id="passerr" class="help-block" style='color:red'></span> 
                </div>
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn green pull-right submit"> Login </button>
                </div>
            </form>
            <!-- END LOGIN FORM -->
        </div>
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2017 &copy;  Monkey 个人博客后台管理系统</div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="/thinkBlogs/Public/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="/thinkBlogs/Public/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        <script src="/thinkBlogs/Public/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        <script src="/thinkBlogs/Public/assets/global/plugins/backstretch/jquery.backstretch.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="/thinkBlogs/Public/assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="/thinkBlogs/Public/assets/pages/scripts/login-4.js" type="text/javascript"></script>
