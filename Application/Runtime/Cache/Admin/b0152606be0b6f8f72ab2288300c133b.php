...
<html lang="en">
    ...
    <div class="col-md-12">
        ...
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-th-list"></i>文章列表</div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            ...
                            <td><img src="/thinkBlogs.<?php echo ($v['thumb_pic']); ?>" alt=""></td>
                            <td> <?php echo ($v['des']); ?> </td>
                            <td> <?php echo ($v['view']); ?> </td>
                            <td> <?php echo ($v['tag']); ?> </td>
                            <td> <?php echo ($v['creat_time']); ?> </td>
                            <td>
                                <a href="<?php echo U('Article/updata', Array('id'=>$v['id']));?>" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit">编辑</i></a>
                                <a href="" class="btn btn-outline btn-circle red btn-sm blue"><i class="fa fa-trash-o">删除</i></a>
                            </td>
                        </tr><?php endforeach; endif; ?>
                    </tbody>
                </table>
                <div class="col-md-7 col-sm-12" style="float:right">
                    <div class="dataTables_paginate paging_bootstrap_number" id="sample_2_paginate" style="text-align: right">
