            ...
            <div class="portlet-body">
                <form role="form" action="/thinkBlogs/index.php/Admin/Article/insert" id="myform" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>文章标题：</label>
                        <input type="text" class="form-control input-large" name="title" id="title" placeholder="文章标题" value="<?php echo ($data['title']); ?>">
                    </div>
                    <div class="form-group">
                        <label>文章描述：</label>
                        <textarea class="form-control input-large" name="des" id="des" placeholder="文章描述"><?php echo ($data['des']); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>列表图片上传：</label>
                        <input type="file" id="listimg" name='listimg'  style="display: inline-block">
                        <div class="img_box">
                            <img src="/thinkBlogs<?php echo ($data['thumb_pic']); ?>" alt="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>文章分类：</label>
                    ...
                    <textarea id="Uedit" class="Uedit" name="content" type="text/plain"><?php echo ($data['content']); ?></textarea>
